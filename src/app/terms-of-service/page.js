  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-16 px-4 md:px-6">
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-3xl border border-black/5 shadow-sm">
        <h1 className="text-4xl md:text-5xl font-black text-text mb-8 tracking-tight">Terms of Service</h1>
        ...
        <div className="space-y-6 text-text-muted leading-relaxed font-medium">
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">1. Provision of Services</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">2. Pricing & Payments</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">3. Warranties & Guarantees</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">4. Liability</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">5. Amendments</h2>
          <p>
